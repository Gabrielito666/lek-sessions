 ...
 *	get(token: string):ISession<TMetadata>|undefined|Promise<ISession<TMetadata>|undefined>;
...
const LekSessions = class
{
	...
	async refreshSession(refresh_token)
	{
		...
		const refresh_token_is_valid = lekCryptools.compareSync(
